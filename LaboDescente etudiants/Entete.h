...
struct TAlgo							//**Definition des parametres de l'algorithme:
{
	...
	int		NbEvalBest;					//**Nombre d'évalutions de solutions nécessaires pour trouver la meilleure solution de l'algorithme (solution finale ou BEST)... forme de convergence
};
